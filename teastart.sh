...
if [[ ! -d logs ]]; then
    echo "Lütfen önce ilk Başlatma opsiyonunu kullanın bu sadece tek seferlik olup Query bilgilerini almak için yapılmalıdır."
    echo "Daha sonra uygulamayı kapatıp sunucuyu Başlat opsiyonuyla başlatın."
    exit 0
fi
